    ...
    <div class="max-w-md w-full space-y-8">
      ...
      >
        ...
        <div>
          ...
          >
            <span v-if="isLoading && !preloadProgress.isVisible" class="absolute left-0 inset-y-0 flex items-center pl-3">
      ...
      <div class="mt-8 text-center">
        ...
        >
          ...
          <svg 
            ...
            :class="{ 'rotate-180': showDevAccounts }"
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
      ...
      <div v-if="showDevHints" class="dev-accounts-floating-container">
        ...
        >
          <div v-if="showDevAccounts" class="dev-accounts-dropdown mt-4 bg-white border border-gray-200 rounded-lg shadow-xl">
            <!-- 人体工学设计的头部：醒目的关闭按钮 -->
            <div class="px-3 py-2 flex items-center justify-between">
              ...
              <button
                ...
                title="Close Developer Accounts"
                aria-label="Close"
              >
            ...
            <div class="accounts-scroll-container">
              ...
              <div class="account-card">
                ...
                <div class="account-content">
                  ...
                  <div class="credential-row">
                    <span class="label">Password:</span>
                    <span class="value" @click="fillAdminCredentials">super123</span>
                  </div>
                </div>
...
const fillAdminCredentials = () => fillCredentials('admin@test.com', 'super123');
...
.dev-accounts-floating-container {
  /* 绝对定位，脱离文档流 */
  position: absolute;
  top: calc(100% - 5rem); /* 向上移动更多，覆盖更多按钮区域 */
  left: 0;
  right: 0;
...
.label {
  color: #9ca3af;
  font-weight: 500;
  font-size: 0.8rem; /* 稍微增大标签字体以提高可读性 */
  line-height: 1.3;
}
...
.min-h-screen {
  ...
  align-items: center;
  justify-content: center;
  padding: 2rem 1rem; /* 均匀的上下padding */
...
@media (max-width: 640px) {
  .dev-accounts-dropdown {
    height: 392px; /* 280px内容 + 112px padding */
  }
...
@media (max-height: 700px) {
  .dev-accounts-dropdown {
    height: 342px; /* 230px内容 + 112px padding */
  }
  
  .min-h-screen {
    padding: 1rem; /* 高度受限时保持简单的padding */
  }
}
...
@media (max-height: 600px) {
  .dev-accounts-dropdown {
    height: 292px; /* 180px内容 + 112px padding */
  }
  
  .min-h-screen {
    padding: 0.5rem; /* 极小屏幕使用最小padding */
  }
}
